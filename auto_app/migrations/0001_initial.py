# Generated by Django 5.1.3 on 2025-02-06 14:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auto_app.food')),
            ],
        ),
        migrations.AddField(
            model_name='food',
            name='food_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auto_app.foodtype'),
        ),
    ]
